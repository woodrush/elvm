...
"u) (o (\\t.\\u.\\v.(j k l b t u p)) o) (n (\\t.\\u.((\\v.(t (\\w.\\A.\\B.((\\A"
".\\B.\\E.(A (E B) (q B E))) A B (\\C.\\D.(w (D ((\\E.(b (\\F.\\G.\\H.(E (y (\\"
"I.\\J.(J ( \\I.\\L.I) I)) F) G)) (E c b))) (\\E.\\b.(r B E (j k l b u o))))(\\"
"E.(E (y (\\F.(F (\\G.\\H.H))) C) (v p))) A) (D (\\E.\\F.\\G.\\H.((\\A.\\B.\\K."
"(A (K B) (q B K))) F G (q H (\\I.\\J.(E (e I C) (s J) (v p))))))) (D (\\E.\\F."
"((\\c.(f (\\H.\\I.I) (E (q F e C)) c c (\\H.(r F)))) c)) v) (s C) (h k C (r D)"
"v) (q D (g k C) j l b u o p) (D (\\D.\\F.(q D (f F F) C (\\G.(r D)))) v) (r D "
"C v))))))) (j k l b u o)))))) (\\s.(h l s (\\a.(a (j k l b) p)))))) (g p))) (h"
" p))))))) (\\i.\\j.(d (\\k.\\i.\\m.\\j.(i (\\o.\\o.\\o.(m (\\o.\\s.\\o.(k i s "
"(\\u.\\i.(k i s (\\w.(j(\\A.(A u w)))))))) (i j))) (j i i))) i c (\\k.\\l.(j k"
")))) b) (\\i.\\j.j))) (d(\\h.\\i.\\j.\\k.(i (\\l.\\m.\\n.(j (\\o.\\p.\\n.(o (h"
" l) (h m) p k)) (k i))) (k c)))))) (d (\\g.\\h.\\i.\\j.\\k.(i (\\l.\\m.\\n.(( "
"\\k.(h (\\p.\\q.\\n.(l (h k) (k q p))) (k (\\p.\\q.q) (\\p.\\q.q)))) (\\o.(g o"
" m j (\\p.\\q.(l (k (\\r.(r p q))) (k (\\r.(r q p))))))))) (k j)))))) (d (\\f."
...
"\\e.(d (e e))) (\\e.(d (e e))))))) ((\\c.(y c(x c (\\d.\\e.e)))) (\\c.\\d.(d( "
"\\c.\\f.c) c)))))";
