...
static const char LAZY_REG_A[] = "`k`k`k`k`ki";
static const char LAZY_REG_B[] = "`k`k`k`k``s`kki";
static const char LAZY_REG_C[] = "`k`k`k``s`kk``s`kki";
static const char LAZY_REG_D[] = "`k`k``s`kk``s`kk``s`kki";
static const char LAZY_REG_SP[] = "`k``s`kk``s`kk``s`kk``s`kki";
static const char LAZY_REG_BP[] = "``s`kk``s`kk``s`kk``s`kk``s`kki";
...
static const char CMP_EQ[] = "`k`k`k`k`ki";
static const char CMP_NE[] = "`k`k`k`k``s`kki";
static const char CMP_LT[] = "`k`k`k``s`kk``s`kki";
static const char CMP_GT[] = "`k`k``s`kk``s`kk``s`kki";
static const char CMP_LE[] = "`k``s`kk``s`kk``s`kk``s`kki";
static const char CMP_GE[] = "``s`kk``s`kk``s`kk``s`kk``s`kki";
